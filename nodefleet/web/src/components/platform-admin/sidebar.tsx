...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    icon: ShoppingCart,
    items: [
      { label: "Orders", href: `${PA}/orders`, icon: ShoppingBag },
      { label: "Pricing", href: `${PA}/pricing`, icon: DollarSign },
      { label: "Payment Gateways", href: `${PA}/payment-gateways`, icon: CreditCard },
      { label: "Shop", href: `${PA}/shop`, icon: Store },
      { label: "Shipping", href: `${PA}/shipping`, icon: Truck },
      { label: "Manufacturing", href: `${PA}/manufacturing`, icon: Factory },
      { label: "Promo Codes", href: `${PA}/promos`, icon: Tag },
      { label: "Inventory", href: `${PA}/inventory`, icon: Package },
      { label: "Invoices", href: `${PA}/invoices`, icon: Receipt },
      { label: "Tax Exemptions", href: `${PA}/tax`, icon: FileX2 },
      { label: "Cart Recovery", href: `${PA}/cart-recovery`, icon: ShoppingCart },
      { label: "Customers", href: `${PA}/customers`, icon: Users },
    ],
  },
  {
    label: "Ranking",
